...
class LanguageData { // TODO: Finish all these
  static final Map<String, Map<String, String>> _localizedValues = {
    ...
    "fr": {
      ...
      "minutes": "Minutes",
      "start": "Démarrer",
      "timerControl": "Contrôle du minuteur",
      "pauseTimer": "Pause du minuteur",
    ...
    "es": {
      ...
      "chooseLanguage": "",
      "exitSettings": "",
      "setTimer": "Definir el minutero",
      "minutes": "Minutos",
      "start": "Iniciar",
      "timerControl": "Control del minutero",
      "pauseTimer": "Pausar el minutero",
      "resumeTimer": "Reanudar el minutero",
      "stopTimer": "Detener el minutero",
      "timerComplete": "Minutero terminado",
    ...
    "it": {
      ...
      "chooseLanguage": "",
      "exitSettings": "",
      "setTimer": "Definisci il timer",
      "minutes": "Minuti",
      "start": "Inizia",
      "timerControl": "Controllo del timer",
      "pauseTimer": "Pausa del timer",
    ...
    "gr": { // Native translator
      ...
      "chooseLanguage": "",
      "exitSettings": "",
      "setTimer": "Ορίστε το χρονόμετρο",
      "minutes": "Λεπτά",
      "start": "Έναρξη",
      "timerControl": "Έλεγχος χρονομέτρου",
      "pauseTimer": "Παύση χρονομέτρου",
      "resumeTimer": "Επανέναρξη χρονομέτρου",
      "stopTimer": "Σταμάτησε το χρονόμετρο",
      "timerComplete": "Χρονόμετρο ολοκληρώθηκε",
    ...
    "ro": { // Native translator
      ...
      "chooseLanguage": "",
      "exitSettings": "",
      "setTimer": "Definiți timerul",
      "minutes": "Minute",
      "start": "Începe",
      "timerControl": "Control timer",
      "pauseTimer": "Pauză timer",
      "resumeTimer": "Reporniți timerul",
      "stopTimer": "Opriți timerul",
      "timerComplete": "Timerul s-a încheiat",
    ...
    "jp": {
      ...
      "minutes": "分",
      "start": "開始",
      "timerControl": "タイマーの制御",
      "pauseTimer": "タイマーを一時停止する",
      "resumeTimer": "タイマーを再開する",
      "stopTimer": "タイマーを停止する",
